      ...
      <section>
        <div className='skillset'>
          <p className='skills-intro'>
            ...
            We continue by laying a solid foundation in core JavaScript, then progress into React. In the final
            quarter students build backend applications with Node and SQL. In total, FEE graduates have the skills
            to turn design comps into working applications.
          </p>
        </div>
        <aside className='technology-container'>
          <div className='frontend'>
            <h2 className='favs'>frontend favs:</h2>
            <p>React, Redux, Sass, Material-UI</p>
            <br></br>
